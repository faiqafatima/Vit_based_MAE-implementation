...
Model Weights
Due to GitHub's file size limits, the trained model weights (best_model.pth) are hosted here: [/kaggle/input/models/faiqarana/mae-weights/pytorch/default/1/best_model.pth]
## Qualitative Results
